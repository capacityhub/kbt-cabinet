...
import departmentChoose from "../../view-components/person/department-choose";
import departmentTreeChoose from "../../view-components/person/department-tree-choose";
import uploadPicInput from "../../view-components/person/upload-pic-input";
