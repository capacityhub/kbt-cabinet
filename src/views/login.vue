<template>
  <Row type="flex" justify="center" align="middle" class="login" @keydown.enter.native="submitLogin">
    <Col class="login-col" :xs="{span:22}">
      <div>
        <Row class="header">
          <img src="../assets/logo.png" class="header-logo"/>
          <div class="description">{{ $t('appName') }}</div>
        </Row>
        ...
        <Row class="login-form">
          ...
          <Row>
            ...
            <router-link to="/regist"><div class="forget-pass">注册账户</div></router-link>
        </Row>
      </div>
